...
final class SpeechRecognizer: ObservableObject {
    ...
    func iniciarReconhecimento() {
        ...
        let novaRequest = SFSpeechAudioBufferRecognitionRequest()
        ...
        guard recordingFormat.sampleRate > 0, recordingFormat.channelCount > 0 else {
            ...
            print("Microfone indisponível ou formato de áudio inválido.")
        ...
        do {
            ...
            print("Erro ao iniciar AudioEngine: \(error)")
        ...
        recognitionTask =
            speechRecognizer.recognitionTask(with: novaRequest) { [weak self] resultado, error in
